...
$core = $core -replace "\.\s*\(Get-AmfetaminUtf8ScriptBlock\s+\(Join-Path\s+\`$PSScriptRoot\s+'AmfetaminDiagnostics\.ps1'\)\)\s*\r?\n", ''
$core = $core -replace "Import-AmfetaminUtf8Script\s+\(Join-Path\s+\`$PSScriptRoot\s+'AmfetaminLogger\.ps1'\)\s*\r?\n", ''
$core = $core -replace "Import-AmfetaminUtf8Script\s+\(Join-Path\s+\`$PSScriptRoot\s+'AmfetaminI18n\.ps1'\)\s*\r?\n", ''
$core = $core -replace "Import-AmfetaminUtf8Script\s+\(Join-Path\s+\`$PSScriptRoot\s+'AmfetaminDiagnostics\.ps1'\)\s*\r?\n", ''
